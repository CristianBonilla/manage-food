...
namespace ManageFood.Domain.SeedWork.Collections.Shop
{
  ...
  {
    int _index;
    static readonly CatalogueCollection _catalogues = SeedData.Shop.Catalogues;
    static readonly InventoryCollection _inventories = SeedData.Shop.Inventories;
    ...
    public ProductEntity[] GetAll() => _products;
